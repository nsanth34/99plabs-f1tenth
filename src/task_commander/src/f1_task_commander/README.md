...
Uses navigation2 package API's and functionality to enable automated task creation for vehicle
...
## Workflow:
- Load config file with commander configurations
- Input file containing waypoint poses
- Pose_loader.py loads text file into list of poses
- navigator accepts list of posestamped objects as argument
